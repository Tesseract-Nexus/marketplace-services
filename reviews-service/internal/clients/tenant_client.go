...
func (c *TenantClient) GetTenantSlug(ctx context.Context, tenantID string) string {
	...
	req.Header.Set("X-Internal-Service", "reviews-service")
...
// BuildReviewsURL builds the URL to the reviews management page
func (c *TenantClient) BuildReviewsURL(ctx context.Context, tenantID string) string {
	return fmt.Sprintf("%s/reviews", c.BuildAdminURL(ctx, tenantID))
}

// BuildProductURL builds the URL to a product page
func (c *TenantClient) BuildProductURL(ctx context.Context, tenantID, productID string) string {
	return fmt.Sprintf("%s/products/%s", c.BuildStorefrontURL(ctx, tenantID), productID)
}

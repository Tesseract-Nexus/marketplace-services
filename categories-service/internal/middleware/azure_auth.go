...
func DevelopmentAuthMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Read user context from headers (set by frontend API client)
		...
		if tenantID == "" {
			tenantID = "00000000-0000-0000-0000-000000000001" // Default for local development
		}
		...
		// Set user context for RBAC middleware compatibility
		...
		c.Set("user_roles", []string{userRole})
